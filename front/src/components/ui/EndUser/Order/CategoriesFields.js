            ...
            cats.push(
                <td
                    ...
                    <h1 style={{ 
                        ...
                        fontSize: '4vw', 
                        color: '#004225', 
                        fontSize: window.innerWidth > 680 ? "20px" : "4vw",
                        padding: window.innerWidth > 680 ? "0" : "0 20px", 
                        }}>{this.props.categories[i].CatName}</h1>
                    <div style={this.categoryImageStyler(i, 0)} >
                        {this.props.categories[i].CatId == this.state.activeCatId ? <CheckCircle id="CatsCheckmark" style={{ height: '4vw', width: '4vw', margin: '5% 0 0 5%' }} /> : null}
                    </div>
                </td>
            )
        }
                        ...
                        proxyCats.push(
                            <td
                                ...
                                <div style={this.categoryImageStyler(k, 1)} >
                                    {this.props.proxyCategories[k].Id == this.state.activeProxyCatId ? <CheckCircle id="SubCatsCheckmark" style={{ height: '4vw', width: '4vw', margin: '5% 0 0 5%' }} /> : null}
                                </div>
                            </td>
                        )
