            ...
            cats.push(
                <td
                    ...
                    <div style={this.categoryImageStyler(i, 0)} >
                        {this.props.categories[i].CatId == this.state.activeCatId ? <CheckCircle id="CatsCheckmark" style={{ height: '4vw', width: '4vw', margin: '5% 0 0 5%', width: this.state.windowWidth > 680 ? "30px" : "4vw", height: this.state.windowWidth > 680 ? "30px" : "4vw" }} /> : null}
                    </div>
                </td>
            )
        }
                        ...
                        proxyCats.push(
                            <td
                                ...
                                <div style={this.categoryImageStyler(k, 1)} >
                                    {this.props.proxyCategories[k].Id == this.state.activeProxyCatId ? <CheckCircle id="SubCatsCheckmark" style={{ height: '4vw', width: '4vw', margin: '5% 0 0 5%', width: this.state.windowWidth > 680 ? "30px" : "4vw", height: this.state.windowWidth > 680 ? "30px" : "4vw" }} /> : null}
                                </div>
                            </td>
                        )
